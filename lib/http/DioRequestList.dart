...
class _GoodListPageState extends State<GoodListPage> {
  ...
  void getGoods() async {
    //请求的url
    var url =
        'http://apis.juhe.cn/cook/query?menu="红烧肉"&key=a9183934319a47a58bd318310124cdd1';
    var formData = {
      'menu': '红烧肉',
      'rn': '10',
      'pn': '0',
      'key': 'a9183934319a47a58bd318310124cdd1'
    };
    ...
    await request(url, formData: formData).then((value) => {
          ...
          setState(() {
            goodListModel =
                Autogenerated.fromJson(json.decode(value.toString()));
          })
        });
  }
